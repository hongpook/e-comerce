...
function Cart() {
  ...
  return (
    <>
      ...
      <div className=" from-slate-400  to-slate-200 mt-36 text-cente min-h-screen">
        ...
        <div className="rounded-2xl backdrop-blur-sm bg-white/30 w-10/12 m-auto ">
          <div className="flex  justify-around items-center p-4 ">
                      ...
                      <>
                        ...
                        >
                          ...
                          <div className=" font-bold p-2 text-center">
                            ...
                            <h4>
                              Price:
                              {/* <span className=" text-blue-600">{`${item.total.toFixed(2)}$`}</span> */}
                              <span className=" text-blue-600"><FormatPrice price={item.ProductPrice}/></span>
                            </h4>
                            <h4>
                              Quantity:{" "}
                              <span className=" text-blue-600">
            ...
            <div className="text-center  p-4">
              ...
              <h1 className="p-2"><FormatPrice price={TotalPrice}/></h1>
              {cart.length > 0 ? (
                <NavLink
                  to="/checkout"
